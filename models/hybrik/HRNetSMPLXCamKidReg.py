...
class HRNetSMPLXCamKidReg(nn.Module):
    def __init__(self, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.preact = get_hrnet(kwargs['HRNET_CONFIG_PATH'], 
                                kwargs['HRNET_TYPE'], num_joints=70,
        ...
        self.smplx_layer = SMPLXLayer(
            ...
            model_path=kwargs['SMPL_MODEL_PATH'],
            num_betas=10,
            use_pca=False,
            age='kid',
            kid_template_path=kwargs['KID_TEMPLATE_PATH'],
        )
