...
def test_transform(src, bbox, input_size=[256, 256], aspect_ratio=1.0, scale_mult=1.25):
    xmin, ymin, xmax, ymax = bbox
    center, scale = _box_to_center_scale(xmin, ymin, xmax - xmin, ymax - ymin, aspect_ratio, scale_mult)
